...
import { URLs } from './user-data/urls.js';
  ...
  const { publicationProjects, nlpProjects, cdmoProjects, challengesProjects } =
    projects;
  ...
  function populatePubblications(items, id) {
  ...
  populatePubblications(pubblications, "pubblications");

  populateProjects(publicationProjects, "pubblication-projects");
  populateProjects(nlpProjects, "nlp-projects");
  populateProjects(cdmoProjects, "cdmo-projects");
  populateProjects(challengesProjects, "challenges-projects");
