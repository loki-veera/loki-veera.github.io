window.addEventListener("DOMContentLoaded", async function () {
    ...
    document.querySelectorAll(".stack-card").forEach(async function (el) {
        ...
        el.innerHTML = `
        <div style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji; border-radius: 6px; line-height: 1.5; padding: 16px; font-size: 14px; color: #24292e; background-color: #C8E0FD;">
    ...
    document.querySelectorAll(".github-card").forEach(async function (el) {
        ...
        el.innerHTML = `
            <div style="font-family: -apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji; border-radius: 6px; line-height: 1.5; padding: 16px; font-size: 14px; color: #24292e; background-color: #2b3137;">
                <div style="display: flex; align-items: center; margin-top: -4px">
                    ...
                    <div style="display: flex; flex-direction: column; margin-left: 12px">
                        <span style="font-weight: 500; color: #white; font-size: 18px">
                            <a style="text-decoration: none; color: white;" target="_blank" href="${html_url}">
                                ${name}
                            </a>
                        </span>
                        <span style="font-weight: 400; color: #fafbfc; font-size: 12px">
                ...
                <div style="margin-top: 12px; display: flex; justify-content: space-evenly; align-items: center; ">
                    <div style="display: flex; flex-direction: column;">
                        <span style="font-size: 10px; font-weight: 500; color: #fafbfc;">
                            REPOSITORIES
                        </span>
